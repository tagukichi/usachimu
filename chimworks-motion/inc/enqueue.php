...
add_action(
	...
	static function () {
		...
		// Lenis スムーススクロール（テーマ同梱・自己ホスト）
		wp_enqueue_script(
			'fde-lenis',
			fde_asset_url( 'assets/js/vendor/lenis.min.js' ),
			[],
			'1.1.18',
			true
		);
		...
		wp_enqueue_script(
			...
			[ 'fde-gsap', 'fde-gsap-scrolltrigger', 'fde-lenis' ],
			null,
			true
		);
	}
...
add_action(
	...
	static function () {
		...
		echo "<link rel=\"stylesheet\" href=\"https://fonts.googleapis.com/css2?family=Geist:wght@300;400;500;600;700&family=Geist+Mono:wght@400;500;600&family=Inter+Tight:wght@500;600;700;800;900&family=Zen+Kaku+Gothic+New:wght@400;500;700;900&family=Noto+Sans+JP:wght@400;500;700;900&display=swap\">\n";
	},
	5
);
