...
$fde_note = (string) fde_option(
	'services_note',
	'契約は **成果物 / マイルストーン単位** が原則。月額顧問契約も可。人月単価の常駐・派遣は行っていません。'
);
$fde_count = is_array( $fde_services ) ? count( $fde_services ) : 0;
?>
<section class="section" id="services" data-section="services">
	<div class="section__inner">
		...
		<div class="services__list">
			<?php foreach ( (array) $fde_services as $s ) : ?>
